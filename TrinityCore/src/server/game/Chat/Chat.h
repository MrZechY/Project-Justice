...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandleArena1Command(const char* args);
        bool HandleArena2Command(const char* args);
        bool HandleArena3Command(const char* args);
        bool HandleArena4Command(const char* args);
