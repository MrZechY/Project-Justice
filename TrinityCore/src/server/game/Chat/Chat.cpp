...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "arena1",         SEC_PLAYER,         false, OldHandler<&ChatHandler::HandleArena1Command>,              "", NULL },
        { "arena2",         SEC_PLAYER,         false, OldHandler<&ChatHandler::HandleArena2Command>,              "", NULL },
        { "arena3",         SEC_PLAYER,         false, OldHandler<&ChatHandler::HandleArena3Command>,              "", NULL },
        { "arena4",         SEC_PLAYER,         false, OldHandler<&ChatHandler::HandleArena4Command>,              "", NULL },
