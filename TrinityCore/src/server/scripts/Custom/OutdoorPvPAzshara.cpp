...
void OPvPCapturePointAzshara::ChangeState()
{
    ...
    case OBJECTIVESTATE_ALLIANCE:
		...
		//QueryResult result = WorldDatabase.PQuery("REPLACE INTO game_graveyard_zone VALUES(%u, 0, 469)", Azshara_MAP_A[m_TowerType]);
        break;
    case OBJECTIVESTATE_HORDE:
        field = Azshara_MAP_H[m_TowerType];
        artkit = 1;
		...
		//QueryResult result = WorldDatabase.PQuery("REPLACE INTO game_graveyard_zone VALUES(%u, 0, 67)", Azshara_MAP_H[m_TowerType]);
        break;
    case OBJECTIVESTATE_NEUTRAL_ALLIANCE_CHALLENGE:
        field = Azshara_MAP_N[m_TowerType];
		//QueryResult result = WorldDatabase.PQuery("REPLACE INTO game_graveyard_zone VALUES(%u, 0, 0)", Azshara_MAP_N[m_TowerType]);
        break;
    case OBJECTIVESTATE_NEUTRAL_HORDE_CHALLENGE:
        field = Azshara_MAP_N[m_TowerType];
		//QueryResult result = WorldDatabase.PQuery("REPLACE INTO game_graveyard_zone VALUES(%u, 0, 0)", Azshara_MAP_N[m_TowerType]);
