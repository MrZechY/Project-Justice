...
enum OutdoorPvPAzsharaPoints
{
	ALLIANCE_POINT = 0,
	HORDE_POINT    = 1,
	NEUTRAl_POINT  = 2,

	AZSHARA_MAX_POINTS = 3
};
...
/*
const float OutDoorPvPAzsharaSpiritGuidePos[AZSHARA_MAX_POINTS][5] = {
	...
	{-123.88880157470f, 856.942199707031f, 298.348693847656f, 0.0f} // Horde Start
};
*/
